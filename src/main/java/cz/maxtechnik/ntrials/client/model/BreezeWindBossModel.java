...
public class BreezeWindBossModel<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition wind_top = partdefinition.addOrReplaceChild("wind_top", CubeListBuilder.create().texOffs(0, 0).addBox(-18.0F, -28.0F, -18.0F, 36.0F, 16.0F, 36.0F, new CubeDeformation(0.0F))
		.texOffs(0, 53).addBox(-13.0F, -28.0F, -13.0F, 25.0F, 16.0F, 26.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 11.0F, 0.0F));

		PartDefinition wind_middle = partdefinition.addOrReplaceChild("wind_middle", CubeListBuilder.create().texOffs(0, 55).addBox(-12.0F, -19.0F, -12.0F, 24.0F, 12.0F, 24.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 0.0F));

		PartDefinition wind_bottom = partdefinition.addOrReplaceChild("wind_bottom", CubeListBuilder.create().texOffs(0, 116).addBox(-4.5F, -14.0F, -4.5F, 9.0F, 14.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
