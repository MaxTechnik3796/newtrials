...
public class BreezeBossModel<T extends Entity> extends EntityModel<T>{
	...
	public static LayerDefinition createBodyLayer(){
		...
		partdefinition.addOrReplaceChild("head",CubeListBuilder.create().texOffs(0,0).addBox(-8.0F,-36.0F,-8.0F,16.0F,16.0F,16.0F,new CubeDeformation(0.0F))
		...
		rotation_1.addOrReplaceChild("rod_1",CubeListBuilder.create().texOffs(0,34).addBox(-2.0F,-31.0F,-2.6424F,4.0F,16.0F,4.0F,new CubeDeformation(0.0F)),PartPose.offsetAndRotation(0.0F,3.0F,-3.0F,0.3927F,0.0F,0.0F));
		...
		rotation_2.addOrReplaceChild("rod_2",CubeListBuilder.create().texOffs(0,34).addBox(-3.0F,-31.0F,-2.6424F,4.0F,16.0F,4.0F,new CubeDeformation(0.0F)),PartPose.offsetAndRotation(0.0F,3.0F,-3.0F,0.3927F,0.0F,0.0F));
		...
		rotation_3.addOrReplaceChild("rod_3",CubeListBuilder.create().texOffs(-4,15).addBox(-3.0F,-31.0F,-2.6424F,4.0F,16.0F,4.0F,new CubeDeformation(0.0F)),PartPose.offsetAndRotation(0.0F,3.0F,-3.0F,0.3927F,0.0F,0.0F));
		...
		rotation_4.addOrReplaceChild("rod_7_r1",CubeListBuilder.create().texOffs(0,34).addBox(-3.0F,-21.0F,-10.0F,4.0F,16.0F,4.0F,new CubeDeformation(0.0F)),PartPose.offsetAndRotation(-8.0F,0.0F,-8.0F,0.0F,1.0472F,0.0F));
		rotation_4.addOrReplaceChild("rod_6_r1",CubeListBuilder.create().texOffs(0,34).addBox(-3.0F,-21.0F,-10.0F,4.0F,16.0F,4.0F,new CubeDeformation(0.0F)),PartPose.offsetAndRotation(-1.0F,0.0F,8.0F,0.0F,3.1416F,0.0F));
		rotation_4.addOrReplaceChild("rod_5_r1",CubeListBuilder.create().texOffs(0,34).addBox(-3.0F,-21.0F,-10.0F,4.0F,16.0F,4.0F,new CubeDeformation(0.0F)),PartPose.offsetAndRotation(8.0F,0.0F,-8.0F,0.0F,-1.0472F,0.0F));
		partdefinition.addOrReplaceChild("heavycore",CubeListBuilder.create().texOffs(0,0).addBox(-2.0F,-34.0F,-2.0F,4.0F,4.0F,4.0F,new CubeDeformation(0.0F))
